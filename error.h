...
typedef enum ErrCode {
    ...
    DATA_MISSING_NUMBERS_E = 45, /* data directive is missing numbers */
    DATA_INVALID_VALUE_E = 46, /* data item is not a valid number */
    DATA_COMMA_BETWEEN_NUMS_E = 47, /* missing comma in the directive */
    DATA_EXTRANEOUS_TEXT_E = 48, /* extraneous text found in the data item */
    DATA_ITEM_NOT_INTEGER_E = 49, /* data item is not an integer */
    INTEGER_OUT_OF_RANGE10_BITS_E = 50, /* integer value is out of range of a word (10 bits) should be between -512 and 511 */
    STR_MISSING_OPEN_QUOTE_E = 51, /* string directive is missing an opening quotation mark */
    STR_MISSING_CLOSE_QUOTE_E = 52, /* string directive is missing a closing quotation mark */
    STR_INVALID_CHAR_E = 53, /* string directive contains invalid characters */
    MAT_INVALID_ROW_E = 54, /* matrix directive has an invalid row */
    MAT_INVALID_COL_E = 55, /* matrix directive has an invalid column */
    MAT_SIZE_ZERO_NEG_E = 56, /* matrix directive has a size of zero */
    MAT_SIZE_TOO_LARGE_E = 57, /* matrix directive has invalid data */
    MISSING_FIRST_OPERAND_E = 58, /* missing first operand in the instruction */
    ONE_OPERAND_COMMA_E = 59, /* one operand but a comma was found */
    MISSING_SECOND_OPERAND_E = 60, /* missing second operand in the instruction */
    THIRD_OPERAND_DETECTED_E = 61, /* more than two operands found */
    MISSING_NUM_OPERAND_E = 62, /* missing numeric operand in the instruction */
    NUMBER_OPERAND_IS_NOT_INTEGER_E = 63, /* number is not an integer */
    INTEGER_OPERAND_OUT_OF_RANGE8_BITS_E = 64, /* integer value is out of range of a byte (8 bits) should be between -128 and 127 */
    REGISTER_NO_R_E = 65, /* register does not start with 'r' */
    REGISTER_NO_DIGIT_E = 66, /* register does not have a digit after 'r' */
    REGISTER_OUT_OF_RANGE_E = 67, /* register number is out of range (0 - 7) */
    OPERAND_EXTRANEOUS_TEXT_E = 68, /* register has extraneous text */
    MAT_EMPTY_ROW_INDEX_E = 69, /* matrix row index is empty */
    MAT_MISSING_FIRST_CLOSING_BRACKET_E = 70, /* matrix is missing the first closing bracket */
    MAT_MISSING_SECOND_BRACKET_E = 71, /* matrix is missing the second bracket */
    MAT_EMPTY_COLUMN_INDEX_E = 72, /* matrix column index is empty */
    MAT_MISSING_SECOND_CLOSING_BRACKET_E = 73, /* matrix is missing the second closing bracket */
    MAT_ROW_NOT_REGISTER_N = 74, /* matrix row is not a register */
    MAT_COL_NOT_REGISTER_N = 75, /* matrix column is not a register */
    OPERAND_IS_KEYWORD_E = 76, /* operand is a keyword */
    OPERAND_IS_MACRO_E = 77, /* operand is a macro */
    OPERAND1_ERROR_N = 78, /* first operand is an error */
    OPERAND2_ERROR_N = 79, /* second operand is an error */
    OPERAND1_UNKNOWN_E = 80, /* first operand is unknown */
    OPERAND2_UNKNOWN_E = 81, /* second operand is unknown */
    OPERAND1_LABEL_DOES_NOT_EXIST_E = 82, /* first operand label does not exist */
    OPERAND2_LABEL_DOES_NOT_EXIST_E = 83, /* second operand label does not exist */
    OPERAND1_NON_MAT_SYMBOL_E = 84, /* first operand is a non-matrix symbol used */
    OPERAND2_NON_MAT_SYMBOL_E = 85, /* second operand is a non-matrix symbol used */
    INSTRUCTION_SRC_OP_CANT_REGISTER_E = 86, /* instruction source operand cannot be a register */
    INSTRUCTION_SRC_OP_CANT_NUM_E = 87, /* instruction source operand cannot be a number */
    INSTRUCTION_DST_OP_CANT_NUM_E = 88, /* instruction destination operand cannot be a number */
