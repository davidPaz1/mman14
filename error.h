...
typedef enum ErrCode {
    ...
    LABEL_ALREADY_EXISTS_E = 31, /* label already exists in the symbol table */
    MACRO_NAME_EXISTS_E = 32, /* macro name already exists */
    MACRO_NAME_TOO_LONG_E = 33, /* macro name is too long */
    MACRO_NAME_EMPTY_E = 34, /* macro name is empty */
    MACRO_INVALID_START_CHAR_E = 35, /* macro name starts with an invalid character */
    MACRO_INVALID_CHAR_E = 36, /* macro name contains invalid characters */
    MACRO_NAME_IS_KEYWORD_E = 37, /* macro name is a keyword */
    DIRECTIVE_DATA_MISSING_E = 38, /* directive is missing data items */
    MISSING_COMMA_E = 39, /* missing comma in the directive */
    DATA_INVALID_VALUE_E = 40, /* data item is not a valid number */
    DATA_ITEM_NOT_INTEGER_E = 41, /* data item is not an integer */
    INTEGER_OUT_OF_RANGE_E = 42, /* integer value is out of range */
    STR_MISSING_OPEN_QUOTE_E = 43, /* string directive is missing an opening quotation mark */
    STR_MISSING_CLOSE_QUOTE_E = 44, /* string directive is missing a closing quotation mark */
    STR_INVALID_CHAR_E = 45, /* string directive contains invalid characters */
    MAT_INVALID_ROW_E = 47, /* matrix directive has an invalid row */
